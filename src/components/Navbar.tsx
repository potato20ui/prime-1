        ...
        <div className="hidden md:flex items-center space-x-4 lg:space-x-6" ref={dropdownRef}>
                ...
                >
                  {[
                    ...
                    <motion.div key={i} variants={dropdownVariants}>
                      <Link
                        to={`/about/${link}`}
                        className="block px-4 py-2 text-[10pt] font-gotham-book text-[#666666] hover:bg-blue-50 transition-colors"
                        onClick={scrollToTop}
                      >
                        {label}
                      </Link>
          ...
          >
            <Link
              to="/contact"
              onClick={scrollToTop}
              className="bg-blue-600 text-white px-4 py-2 rounded-full shadow-md hover:bg-blue-700 transition-all text-[14pt] font-gotham-bold"
            >
              Contact Us
            </Link>
          </motion.div>
