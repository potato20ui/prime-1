      ...
      <span className="text-[#0E406F] font-bold">You</span> Advance.
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-4 text-center md:text-left w-full max-w-lg mx-auto md:mx-0">
            <div className="flex flex-col p-2 sm:p-3 items-center bg-white/10 rounded-lg backdrop-blur-sm">
              <span className="text-xl sm:text-2xl md:text-3xl lg:text-[22pt] font-bold text-white">{sales.toLocaleString()}M+</span>
              <span className="text-xs sm:text-sm text-[#0E406F] uppercase tracking-wider">Sales</span>
            </div>
            <div className="flex flex-col p-2 sm:p-3 items-center bg-white/10 rounded-lg backdrop-blur-sm">
              <span className="text-xl sm:text-2xl md:text-3xl lg:text-[22pt] font-bold text-white">{clients.toLocaleString()}+</span>
              <span className="text-xs sm:text-sm text-[#0E406F] uppercase tracking-wider">Clients</span>
            </div>
            <div className="flex flex-col p-2 sm:p-3 items-center bg-white/10 rounded-lg backdrop-blur-sm">
              <span className="text-xl sm:text-2xl md:text-3xl lg:text-[22pt] font-bold text-white">{projects.toLocaleString()}+</span>
              <span className="text-xs sm:text-sm text-[#0E406F] uppercase tracking-wider">Projects</span>
            </div>
            <div className="flex flex-col p-2 sm:p-3 items-center bg-white/10 rounded-lg backdrop-blur-sm">
              <span className="text-xl sm:text-2xl md:text-3xl lg:text-[22pt] font-bold text-white">{studies.toLocaleString()}+</span>
              <span className="text-xs sm:text-sm text-[#0E406F] uppercase tracking-wider">Studies</span>
            </div>
          </div>
        </div>
      </div>
