...
const ServicesPage = () => {
  ...
  const contentMap: Record<number, React.ReactNode> = {
    1: (
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ac risus
        ac libero tincidunt auctor. Proin interdum, nulla a vehicula elementum,
        nisi eros tincidunt purus, a posuere justo felis ac justo.
      </p>
    ),
    2: (
      <p>
