...
import { Link } from "react-router-dom";
 ...
 const properties = [
   { id: 1, title: "Modern Office Space", type: "Quezon City", png: "/mockup.png" },
   { id: 2, title: "Retail Shop Space", type: "Makati", png: "/mockup.png" },
   { id: 3, title: "Warehouse Facility", type: "Taguig", png: "/mockup.png" },
   { id: 4, title: "Studio Unit", type: "Ortigas", png: "/mockup.png" },
   { id: 5, title: "Commercial Lot", type: "Quezon City", png: "/mockup.png" },
   { id: 6, title: "Small Office", type: "Mandaluyong", png: "/mockup.png" },
   { id: 7, title: "Small Office", type: "Mandaluyong", png: "/mockup.png" },
 ];
 ...
 export default function PropertiesPage() {
   ...
   return (
     <div className="min-h-screen bg-white">
        <Navbar/>
{/* Properties Banner Section */}
<section className="relative mb-10">
  <div
    className="w-full h-[500px] rounded-lg overflow-hidden relative group"
    style={{ backgroundImage: "url('/images/ui/bg.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}
  >
    {/* Overlay */}
