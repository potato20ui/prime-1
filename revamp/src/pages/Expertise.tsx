...
const ExpertisePage = () => {
  ...
  const contentMap: Record<number, React.ReactNode> = {
    ...
    4: <p>Leverage our seasoned experience to navigate complex real estate challenges effortlessly.</p>,
    5: <p>Accelerate your investments with innovative approaches and market-driven solutions.</p>,
    1: (
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            {[...Array(3)].map((_, index) => (
              <div key={index} className="flex-1 bg-gray-200 rounded-md overflow-hidden">
                <img
                  src={`https://via.placeholder.com/600x400?text=Selling+Image+${index + 1}`}
        ...
        <div>
          ...
          <div className="flex space-x-4">
            {[...Array(3)].map((_, index) => (
              <div key={index} className="flex-1 bg-gray-200 rounded-md overflow-hidden">
                <img
                  src={`https://via.placeholder.com/600x400?text=Buying+Image+${index + 1}`}
